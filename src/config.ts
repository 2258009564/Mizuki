...
export const siteConfig: SiteConfig = {
	...
	bilibili: {
		vmid: "98732441", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/alisa22580透明背景.png", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "alisa22580",
	bio: "您想生活在怎样的虚拟世界里？",
	typewriter: {
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://vercel-repo-fawn.vercel.app",
		lang: SITE_LANG,
	},
};
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	// https://music.163.com/#/playlist?id=17739906691&creatorId=6478011083
	id: "17739906691", // 歌单ID
